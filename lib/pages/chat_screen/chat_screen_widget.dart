...
class _ChatScreenWidgetState extends State<ChatScreenWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MessagesRow>>(
      stream: _model.chatScreenSupabaseStream ??= SupaFlow.client
          .from("messages")
          ...
          .map((list) => list.map((item) => MessagesRow(item)).toList()),
      builder: (context, snapshot) {
        ...
        List<MessagesRow> chatScreenMessagesRowList = snapshot.data!;
                        ...
                        children: [
                          FutureBuilder<List<PropertiesRow>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<PropertiesRow>
                                  propertyCardPropertiesRowList =
                                  snapshot.data!;

                              final propertyCardPropertiesRow =
                                  propertyCardPropertiesRowList.isNotEmpty
                                      ? propertyCardPropertiesRowList.first
                                      : null;
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${propertyCardPropertiesRow?.city}, ${propertyCardPropertiesRow?.state}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .labelSmall
                                                    .override(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final messages =
                                      chatScreenMessagesRowList.toList();
                              ...
                              if (_model.textController.text != '') {
                                ...
                                await ConversationsTable().update(
                                  data: {
                                    ...
                                    'last_message_at': supaSerialize<DateTime>(
                                        getCurrentTimestamp),
