...
class PropertyDetailsPageWidget extends StatefulWidget {
  ...
  static String routeName = 'PropertyDetailsPage';
...
class _PropertyDetailsPageWidgetState extends State<PropertyDetailsPageWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PropertiesRow>>(
      future: PropertiesTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<PropertiesRow> propertyDetailsPagePropertiesRowList =
            snapshot.data!;

        final propertyDetailsPagePropertiesRow =
            propertyDetailsPagePropertiesRowList.isNotEmpty
                ? propertyDetailsPagePropertiesRowList.first
                : null;
              ...
              children: [
                SingleChildScrollView(
                  child: Column(
                          ...
                          child: Column(
                            ...
                            children: [
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                              ...
                                              text: TextSpan(
                                                children: [
                                                  ...
                                                  TextSpan(
                                                    text:
                                                        valueOrDefault<String>(
                                                      '/ ${propertyDetailsPagePropertiesRow?.rentPeriod}',
                                                      '/ year',
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                            ...
                                            Text(
                                              '${propertyDetailsPagePropertiesRow?.city}, ${propertyDetailsPagePropertiesRow?.state}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    propertyDetailsPagePropertiesRow?.title,
                                    'Title',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.network(
                                          'https://static0.anpoimages.com/wordpress/wp-content/uploads/2024/10/how-to-drop-a-pin-in-google-maps.png',
                                          width: 215.0,
                                          height: 91.0,
                                          fit: BoxFit.cover,
                                        ),
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 8.0, 0.0, 0.0),
                                                  child: Text(
                                                    '2.4 km from Admiralty Way Close to malls, schools and major roads.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
                    ...
                    ].addToEnd(SizedBox(height: 115.0)),
                  ),
                ),
                Align(
                  alignment: AlignmentDirectional(0.0, 1.0),
