...
import 'message_list_screen_landlord_model.dart';
export 'message_list_screen_landlord_model.dart';

class MessageListScreenLandlordWidget extends StatefulWidget {
  const MessageListScreenLandlordWidget({super.key});

  static String routeName = 'MessageListScreenLandlord';
  static String routePath = '/messageListScreenLandlord';

  @override
  State<MessageListScreenLandlordWidget> createState() =>
      _MessageListScreenLandlordWidgetState();
}

class _MessageListScreenLandlordWidgetState
    extends State<MessageListScreenLandlordWidget> {
  late MessageListScreenLandlordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageListScreenLandlordModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ConversationsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ConversationsRow> messageListScreenLandlordConversationsRowList =
            snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final messageList =
                              messageListScreenLandlordConversationsRowList
                                  .toList();
