...
import 'property_filters_model.dart';
export 'property_filters_model.dart';

class PropertyFiltersWidget extends StatefulWidget {
  const PropertyFiltersWidget({super.key});

  static String routeName = 'PropertyFilters';
  static String routePath = '/propertyFilters';
...
class _PropertyFiltersWidgetState extends State<PropertyFiltersWidget> {
  late PropertyFiltersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PropertyFiltersModel());
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ChipData('Apartment'),
                                          ChipData('Self Contain'),
                                          ChipData('Duplex'),
                                          ChipData('Bungalow'),
                                          ChipData('Penthouse'),
                                          ChipData('Semi-detached House'),
                                          ChipData('Detached House'),
                                          ChipData('Villa'),
                                          ChipData('Mansion'),
                                          ChipData('Shortlet')
                                        ],
                                    ...
                                    children: [
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ...
                                          ChipData('Security'),
                                          ChipData('Furnished'),
                                          ChipData('Water Supply'),
                                          ChipData('Newly Built'),
                                          ChipData('Prepaid Meter')
                                        ],
                                        onChanged: (val) => safeSetState(() =>
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 50.0, 24.0, 16.0),
                    child: Container(
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
