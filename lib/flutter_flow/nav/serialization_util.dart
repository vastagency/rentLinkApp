    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case LandlordVerificationsRow:
            return LandlordVerificationsRow(data);
          case MessagesRow:
          ...
          case SavedPropertiesRow:
            return SavedPropertiesRow(data);
          case SavingsPlansRow:
            return SavingsPlansRow(data);
          case SavingsTransactionsRow:
            return SavingsTransactionsRow(data);
          default:
            return null;
        }
