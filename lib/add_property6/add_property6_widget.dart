...
import 'add_property6_model.dart';
export 'add_property6_model.dart';

class AddProperty6Widget extends StatefulWidget {
  const AddProperty6Widget({super.key});

  static String routeName = 'AddProperty6';
  static String routePath = '/addProperty6';

  @override
  State<AddProperty6Widget> createState() => _AddProperty6WidgetState();
}

class _AddProperty6WidgetState extends State<AddProperty6Widget> {
  late AddProperty6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProperty6Model());
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Kindly review your property details.',
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Property has been saved as draft!',
                                style: TextStyle(
                                  color:
                                      FlutterFlowTheme.of(context).primaryText,
                                ),
